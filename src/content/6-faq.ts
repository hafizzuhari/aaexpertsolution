export const faq = {
  ...
  en: {
    ...
    items: [
      {
        question: "Do you provide on-site visits for measurements?",
        answer: "Yes, we provide a free on-site visit and free quotation for all our customers.",
      },
      {
      ...
      },
      {
        ...
        answer: "Absolutely! We can build entirely to your taste.",
      },
    ],
  },
}
