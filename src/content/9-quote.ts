export const quote = {
  ...
  ms: {
    ...
    formFields: [
      ...
      { label: "Jenis Projek", name: "projectType", type: "select", options: ["Renovasi Rumah", "Bumbung & Awning", "Kerja Am Pembinaan", "Pagar, Grill & Railing", "Pintu Pagar & Autogate", "Fabrikasi Keluli", "Lain-lain"], required: true },
  ...
  en: {
    ...
    formFields: [
      ...
      { label: "Project Type", name: "projectType", type: "select", options: ["Home Renovation", "Roofing & Awnings", "General Building Works", "Fencing, Grilles & Railings", "Gates & Autogate", "Steel Fabrication", "Other"], required: true },
